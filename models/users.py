...
class User(db.Model):
    ...
    status = db.Column(db.Enum(UserStatus), nullable=False, default=UserStatus.ANONYMOUS)
...
class ChatSession(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    chat_id = db.Column(db.String(36), unique=True, nullable=False, default=lambda: str(uuid.uuid4()))
